...
import { getChannelVideos, getChannelShorts } from '../api/youtube';
...
const ChannelScreen = ({ route, navigation }) => {
    ...
    const channelInfo = {
        ...
        subscribers: '615K người đăng ký',
        videoCount: '1.1K video',
        description: 'All content on this channel is authorized, all copyright related issues please contact: thietvu.1904@gmail.com',
        links: ['tiktok.com/@thietreview và 1 đường liên kết khác'],
        banner: null,
    };
